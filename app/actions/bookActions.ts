...
import {
  ...
  fetchBookById,
  fetchBookImage,
  fetchBookImageByBookId,
  fetchBookNameByBookId,
  fetchBookPages,
  fetchBooksByPage,
  fetchBooksByQuery,
  fetchNewBook,
...
export async function fetchBookNameByBookIdAction(id: number) {
  try {
    return await fetchBookNameByBookId(id);
  } catch (error) {
    console.error("Server Action Error:", error);
    throw new Error("Failed to fetchTotalBookPage");
  }
}
export async function fetchBookImageByBookIdAction(id: number) {
  try {
    return await fetchBookImageByBookId(id);
  } catch (error) {
    console.error("Server Action Error:", error);
