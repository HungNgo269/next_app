"use client";
import { UpdateChapterAction } from "@/app/(admin)/dashboard/books/[bookId]/chapters/[chapterId]/updateChapterAction";
...
export default function UpdateChapterForm({ chapter, bookId }: props) {
