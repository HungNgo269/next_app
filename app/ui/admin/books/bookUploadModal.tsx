...
export default function BookUploadModal({
  ...
  const [state, formAction, isPending] = useActionState(uploadBookAction, null);
    ...
    >
      <div className="bg-white max-w-3xl w-full max-h-[95vh] overflow-hidden shadow-2xl rounded-lg">
        <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-gradient-to-r from-primary/5 to-accent/5">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Upload Book</h2>
        ...
        <div className="overflow-y-auto max-h-[calc(95vh-80px)]">
          <form key={formKey} action={formAction} className="p-6 space-y-6">
            ...
            <FormField
              ...
              value={desc}
              onChange={setDesc}
              placeholder="Describe your Book content..."
              required
              disabled={isPending}
