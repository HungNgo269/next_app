...
import { EditSlideAction } from "@/app/(admin)/dashboard/slides/editSlideAction";
...
export default function EditSlideModal({
  ...
  const [state, formAction, isPending] = useActionState(EditSlideAction, null);
  ...
  console.log("cuern", currentSlideData);
  // Validation TODO => zod
